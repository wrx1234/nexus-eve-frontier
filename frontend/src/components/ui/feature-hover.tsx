...
interface FeatureItem { title: string; description: string; icon: ReactNode }

export function FeaturesWithHoverEffects({ features }: { features: FeatureItem[] }) {
  return (
...
function Feature({ title, description, icon, index }: FeatureItem & { index: number }) {
  return (
    <div className={cn(
